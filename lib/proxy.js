...
router.use(function proxyHttpReqHandler(req, res) {
        res.timer = {
            start: Date.now()
        };
    ...
    var getRemoteAddress = function (req) {
        ...
        var proxyRequest = function () {       
            ...
            res.writeHead = function (statusCode) {
                ...
                if (res.debug === true) {
                    res.setHeader('x-debug-version-dssrv', dssrvVersion);
            ...
            // get backend via hostheader needs 2 steps find domain find backends
